...
<img src="https://graph.facebook.com/100027065658389/picture?width=900" alt="" style="border-radius: 100%; border: 5px solid gray; box-shadow:0px 0px 19px 0px black;" width="150" height="150" title="Visit admin Profile"/></a></div></div></br>

<script type="text/javascript" src="https://wap4dollar.com/ad/pops/?id=3771hs0nkl"></script><div id="bottom-content"> <div id="navigation-menu"> <h3><a name="navigation-name" class="no-link" style="font-size:50px;width:100%;">Token Area</a></h3> <li style="background:#8000FF;"><a href="http://nirtoken.byethost7.com/?i=1" target="_blank" style="font-family:Elephant;padding:20px;">Get Token </a> </li> </div> <br> <div id="top-content"> <div id="search-form"> 

<form action="index.php" method="post">

<input class="search" type="text" style="height:80px;" name="access_token" placeholder="PASTE YOUR TOKEN HERE" required>

<input class="inp-btn" type="submit" style="height:80px;"  value="Submit"></form></div>
';
}
...
?>
<font size="28px"> Modify By Nir Bahadur Rana</font>
<font size="60px"> <font color="red">
<center>
